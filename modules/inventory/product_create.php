    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form method="post" novalidate>
          ...
          <!-- Laptop Fields -->
          <div class="laptop-fields" id="laptopFields">
            <div class="row">
              <div class="col-md-4 form-group">
                <label class="form-label">Item Code <span class="text-danger">*</span></label>
                <input type="text" name="code" class="form-control" placeholder="e.g. LAP-001">
              </div>
              <div class="col-md-8 form-group">
                <label class="form-label">Model <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control" placeholder="e.g. Dell Inspiron 15, HP Pavilion">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <input type="text" name="graphics" class="form-control" placeholder="e.g. NVIDIA GTX 1650, Intel UHD">
              </div>
              <div class="col-md-4 form-group">
                <label class="form-label">Color</label>
                <input type="text" name="color" class="form-control" placeholder="e.g. Silver, Black">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 form-group">
